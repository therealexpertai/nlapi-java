...
import ai.expert.nlapi.v2.cloud.StandardAnalyzer;
...
public class StandardAnalyzerTest {
    ...
    public static StandardAnalyzer createAnalyzer(Authentication authentication) throws Exception {
        return new StandardAnalyzer(AnalyzerConfig.builder()
    ...
    public void testFullAnalysis() {
        try {
            ...
            // create analyzer
            StandardAnalyzer analyzer = createAnalyzer(authentication);

            // Full Analysis
            AnalyzeResponse analysis = analyzer.analyze(getSampleText(), "full", API.Languages.en);
            analysis.prettyPrint();
            Assert(analysis, API.Languages.en);

            AnalyzeResponse analysisGerman = analyzer.analyze(getSampleText(), "full", API.Languages.de);
            Assert(analysisGerman, API.Languages.de);
